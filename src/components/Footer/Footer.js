    ...
    return (
        <Container fluid className="mt-5 footer-bg ">
            ...
            {/* footer part 1st column */}
                <Col md={3}>
                    <div className="d-flex flex-column align-items-start p-3">
                        <h2 className="logo-text p-0 m-0 text-dark mb-3"> SP <span>Travency</span> </h2>
                        <p className="quote p-0 m-0 text-dark">There’s a sunrise and a sunset every single day, and they’re absolutely free. Don’t miss so many of them</p>
                        <div className="mt-4 d-flex justify-content-evenly align-items-center text-dark">
            ...
            {/* footer part 4th column */}
                ...
                <Col md={3}>
                    <div className="text-dark p-3 contact">
